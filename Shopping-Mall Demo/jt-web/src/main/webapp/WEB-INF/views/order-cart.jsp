...
<!--shortcut end-->
	...
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://www.jt.com/"><img src="/images/jt-logo.png"  alt="京东商城" /></a></div>
	...
	<div class="s-content payment-info">
        ...
        <div class="way-list">
	        			        				         <div class="way-item">
			            京东快递&nbsp;&nbsp;中小件商品&nbsp;&nbsp;<font color='#FF6600;'>工作日、双休日与假日均可送货</font> &nbsp;  
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	$('#bill-tip-btn').Jtips({//随点随帮tip弹出
		"content":'<a target="_blank" href="http://help.jd.com/help/question-61.html#kjfpf">如何区分京东销售和第三方卖家销售的商品?</a>',
		"close":true,			
	    "position": 'bottom'
	});
	//<![CDATA[
